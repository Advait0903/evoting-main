            ...
            <>
              {this.state.currentVoter.isRegistered ? (
                this.state.currentVoter.isVerified ? (
                  ...
                  <div className="container-item attention">
                    <center>Please wait for the admin to verify.</center>
                  </div>
                )
              ) : (
                <>
                  <div className="container-item attention">
                    <center>
                      <p>You're not a registered voter. Please register first.</p>
                      <br />
                      <Link
                        to="/Registration"
              ...
              <div className="container-main">
                ...
                {this.state.candidates.length < 1 ? (
                  <div className="container-item attention">
                    <center>No candidate to vote for.</center>
                  </div>
                ) : (
                  <>
                    ...
                    >
                      <center>Vote at your own free will. Your privacy and platform-security is well ensured!</center>
                    </div>
                  </>
                )}
              </div>
